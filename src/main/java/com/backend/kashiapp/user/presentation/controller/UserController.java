...
public class UserController {
    ...
    public UserController(LoginUseCase loginUseCase, RegisterUserUseCase registerUserUseCase, VerifyOptUseCase verifyOptUseCase, GetUserUseCase getUserUseCase) {
    ...
    public ResponseEntity<UserProfileResponseDTO> getCurrentUser() {
        UserProfileResponseDTO response = getUserUseCase.getCurrentUserProfile("user@example.com");
        return ResponseEntity.ok(response);
    }
}